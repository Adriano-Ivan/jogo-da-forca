...
const categorias = {
  frutas: ["abacate", "limao", "uva", "manga", "pera", "maça"],
  profissoes: [
    "engenheiro",
    "programador",
    "enfermeiro",
  ...
  cores: ["preto", "amarelo", "branco", "roxo", "azul", "vermelho"],
  animais: ["girafa", "rinoceronte", "bufalo", "cachorro", "leao", "peixe"],
};
...
function verificaFimDeJogo() {
  if (!palavraInterface.innerHTML.includes("-")) {
    ...
    desenhaOlhos();
    exibePalavraInterface(
      "Infelizmente, agora você perdeu ! Tente novamente !"
    );
  }
}
